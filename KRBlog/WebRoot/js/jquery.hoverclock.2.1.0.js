...
(function ($) {
    $.fn.hoverclock = function (options) {
        ...
        var settings = $.extend({
            ...
            h_backColor: "transparent",//背景颜色
            h_width: "300px",//宽度
            h_height: "300px",//高度
            h_secondHandColor: "red",//秒针演示
            h_frontColor: "darkgreen",//时针
            h_thinHandColor: "green",//分针颜色
            h_linkText: "HoverClock",//链接文字
            h_linkUrl: "#",//http://hovertree.com/texiao/hoverclock/
            h_linkColor: "deeppink",//链接字体颜色
            h_linkSize: "16px",
            h_hourLength: "",//时针长度
            h_minuteLength: "",//分针长度
            h_secondLength: "",//秒针长度
        ...
        for (var i = 0; i < 60; i++) {
            ...
            if ((i % 5) == 0) {
                ...
                if (settings.h_minuteNumShow) {
                	//osen 修改了这里的颜色 green
                    createNum(h_hudu, 80, "transparent", h_text, "#FFF", settings.h_minute5Height + 4, h_scaleRadii - 4);
                }
                else {
                    if ((i % 15) == 0) {
